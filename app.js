...
app.use(function (req, res, next) {
  ...
  const allowedOrigins = [ 'https://scintillating-toffee-28fea0.netlify.app', 'https://group19project.netlify.app/', 'https://darling-sunshine-0ef6da.netlify.app', 'http://localhost:3001'];
