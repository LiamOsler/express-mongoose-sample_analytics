...
app.use(function (req, res, next) {
  ...
  const allowedOrigins = [ 'https://group19project.netlify.app', 'https://darling-sunshine-0ef6da.netlify.app', 'https://csci4177-group19-project.vercel.app', 'https://localhost:3001'];
